...
<html>
    <head>
        <title>Star Mining Company || Deposit</title>
        <link rel="icon" href="star.jpg" type="x-icon image">
        <style>
...
.button button {
  ...
  .button button i {
   ...
   <div class="container">
    ...
    <div class="price">
        <h1>Awesome, that's KES 100</h1> <!-- For testing purposes The Amount will be parsed from the price of the machine-->
    </div>
    <div class="card__container">
        <div class="card">
            <div class="row">
                    <img src="mpesa.png" style="width:30%;margin: 0 35%;">
                    <p style="color:#8F92C3;line-height:1.7;">1. Enter the <b>phone number</b> and press "<b>Deposit</b>"</br>2. You will receive a popup on your phone. Enter your <b>MPESA PIN</b></p>
                    <?php if ($errmsg != ''): ?>
    ...
    <div class="button">
        <button type="submit"><i class="ion-locked"></i> Deposit</button>
    </div>
    </form>
    <p style="color:#8F92C3;line-height:1.7;margin-top:5rem;">Copyright 2024 | All Rights Reserved | Star Mining Company</p>
</div>
   </body>
</html>