...
$config = array(
    "env"              => "sandbox",
    "BusinessShortCode"=> "8436178", // For testing purposes ONLY!...Your number here eg till number or paybill
    "key"              => "bFSoyCTXpmdBOXTry2vCAXj6rYb9EWImfzbquJOEhzrw0Kp0", // consumer key here
    "secret"           => "8cpu0JqE9EVGEWR7thPSrOMcBNN4KuZMNIV0OtQKG1vFNp3FI6cqDB4UrO7supDX", // consumer secret here
    "username"         => "apitest",
    "TransactionType"  => "CustomerPayBillOnline",
    "passkey"          => "bfb279f9aa9bdbcf158e97dd71a467cd2e0c893059b10f78e6b72ada1ed2c919", // passkey here
    "CallBackURL"      => "https://f899-41-90-64-220.ngrok.io/mpesa/callback.php", // Use Ngrok to forward the response to your Localhost
    "AccountReference" => "Star Mining Company",
    "TransactionDesc"  => "Payment To Star Mining Company" ,
);
